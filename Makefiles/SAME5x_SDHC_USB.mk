...
SAME5x_SDHC_USB_EXCLUDE_DIRS := \
	$(SAME5x_SDHC_USB_SRC_DIR)/RP2040 \
	$(SAME5x_SDHC_USB_SRC_DIR)/SAM4S_4E_E70 \
	$(SAME5x_SDHC_USB_SRC_DIR)/SAME5x_C21/SAMC21 \
	$(SAME5x_SDHC_USB_SRC_DIR)/STM32 \
	$(SAME5x_SDHC_USB_SRC_DIR)/STMCubeMX \
	$(SAME5x_SDHC_USB_SRC_DIR)/atmel \
	$(SAME5x_SDHC_USB_SRC_DIR)/arm

SAME5x_SDHC_USB_CSRC := $(filter-out $(addsuffix /%,$(SAME5x_SDHC_USB_EXCLUDE_DIRS)),$(call rwildcard,$(SAME5x_SDHC_USB_SRC_DIR),*.c))

SAME5x_SDHC_USB_CPPSRC := $(filter-out $(addsuffix /%,$(SAME5x_SDHC_USB_EXCLUDE_DIRS)),$(call rwildcard,$(SAME5x_SDHC_USB_SRC_DIR),*.cpp))
