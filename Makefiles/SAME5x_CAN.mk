...
# Compiler flags - C++
SAME5x_CAN_CXXFLAGS := -c -std=c++20 \
	-mcpu=cortex-m4 -mthumb -mfpu=fpv4-sp-d16 -mfloat-abi=hard \
	-fno-math-errno -mfp16-format=ieee \
...
# Source files
SAME5x_CAN_EXCLUDE_DIRS := \
	$(SAME5x_CAN_SRC_DIR)/RP2040 \
	$(SAME5x_CAN_SRC_DIR)/SAM4S_4E_E70 \
	$(SAME5x_CAN_SRC_DIR)/SAME5x_C21/SAMC21 \
	$(SAME5x_CAN_SRC_DIR)/SAME5x_C21/SAME5x/usb \
	$(SAME5x_CAN_SRC_DIR)/STM32 \
	$(SAME5x_CAN_SRC_DIR)/STMCubeMX \
	$(SAME5x_CAN_SRC_DIR)/atmel \
	$(SAME5x_CAN_SRC_DIR)/arm

SAME5x_CAN_CSRC := $(filter-out $(addsuffix /%,$(SAME5x_CAN_EXCLUDE_DIRS)),$(call rwildcard,$(SAME5x_CAN_SRC_DIR),*.c))

SAME5x_CAN_CPPSRC := $(filter-out $(addsuffix /%,$(SAME5x_CAN_EXCLUDE_DIRS)),$(call rwildcard,$(SAME5x_CAN_SRC_DIR),*.cpp))
