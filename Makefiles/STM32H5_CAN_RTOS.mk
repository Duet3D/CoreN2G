...
# Source files
STM32H5_CAN_RTOS_EXCLUDE_DIRS := \
	$(STM32H5_CAN_RTOS_SRC_DIR)/RP2040 \
	$(STM32H5_CAN_RTOS_SRC_DIR)/SAM4S_4E_E70 \
	$(STM32H5_CAN_RTOS_SRC_DIR)/SAME5x_C21 \
	$(STM32H5_CAN_RTOS_SRC_DIR)/STMCubeMX/Drivers/STM32H7xx_HAL_Driver \
	$(STM32H5_CAN_RTOS_SRC_DIR)/STMCubeMX/Drivers/CMSIS/Device/ST/STM32H7xx \
	$(STM32H5_CAN_RTOS_SRC_DIR)/atmel \
	$(STM32H5_CAN_RTOS_SRC_DIR)/arm

STM32H5_CAN_RTOS_CSRC := $(filter-out $(addsuffix /%,$(STM32H5_CAN_RTOS_EXCLUDE_DIRS)),$(call rwildcard,$(STM32H5_CAN_RTOS_SRC_DIR),*.c))

STM32H5_CAN_RTOS_CPPSRC := $(filter-out $(addsuffix /%,$(STM32H5_CAN_RTOS_EXCLUDE_DIRS)),$(call rwildcard,$(STM32H5_CAN_RTOS_SRC_DIR),*.cpp))
