...
void HAL_ADC_MspInit(ADC_HandleTypeDef* hadc)
{
  ...
  */
    ...
    PC5     ------> ADC1_INP8
    */
    GPIO_InitStruct.Pin = TEMP0_Pin|TEMP1_Pin|TEMP2_Pin|VIN_MON_Pin
                          |BOARD_TYPE_Pin|HEATER_CURRENT_Pin;
...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* hadc)
{
  if(hadc->Instance==ADC1)
  {
    ...
    PC5     ------> ADC1_INP8
    */
    HAL_GPIO_DeInit(GPIOC, TEMP0_Pin|TEMP1_Pin|TEMP2_Pin|VIN_MON_Pin
                          |BOARD_TYPE_Pin|HEATER_CURRENT_Pin);
...
void HAL_LPTIM_MspPostInit(LPTIM_HandleTypeDef* hlptim)
{
  ...
  if(hlptim->Instance==LPTIM1)
  {
    ...
    PB2     ------> LPTIM1_CH1
    */
    GPIO_InitStruct.Pin = IO0_OUT_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_MEDIUM;
    GPIO_InitStruct.Alternate = GPIO_AF5_LPTIM1;
    HAL_GPIO_Init(IO0_OUT_GPIO_Port, &GPIO_InitStruct);
...
void HAL_SPI_MspDeInit(SPI_HandleTypeDef* hspi)
{
  ...
  else if(hspi->Instance==SPI2)
  {
    ...
    PB15     ------> SPI2_MOSI
    */
    HAL_GPIO_DeInit(GPIOB, GPIO_PIN_1|GPIO_PIN_13|GPIO_PIN_14|GPIO_PIN_15);
...
void HAL_TIM_MspPostInit(TIM_HandleTypeDef* htim)
{
  ...
  else if(htim->Instance==TIM2)
  {
    ...
    PA2     ------> TIM2_CH3
    */
    GPIO_InitStruct.Pin = NP_OUT_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_HIGH;
    GPIO_InitStruct.Alternate = GPIO_AF1_TIM2;
    HAL_GPIO_Init(NP_OUT_GPIO_Port, &GPIO_InitStruct);
