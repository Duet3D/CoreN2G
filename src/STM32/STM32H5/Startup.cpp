...
void PeriphCommonClock_Config() noexcept;
...
#if 0	// add this call if we need to use PLL2
...
void SystemClock_Config(void)
{
  ...
  */
  ...
  RCC_OscInitStruct.PLL.PLLP = 2;				// 240MHz on the main output
  RCC_OscInitStruct.PLL.PLLQ = 10;				// 48MHz for CAN
...
#if 0	// call this if we need to use PLL2
/**
...
void PeriphCommonClock_Config() noexcept
{
  ...
  */
  __HAL_RCC_PLL2_CONFIG(RCC_PLL2_SOURCE_HSE, 2, 40, 6, 5, 2);
