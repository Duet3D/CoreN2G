...
public:
	...
	bool TransceivePacket(const uint8_t *_ecv_array _ecv_null tx_data, uint8_t *_ecv_array _ecv_null rx_data, size_t len, uint32_t dmaTimeout = SpiDevice::SpiDmaTimeout) const noexcept;
