/* Config file hpl_gclk_config.h, originally auto-generated by Atmel Start
 * The configuration we use is:
 * GCLK0 is fed from DPLL0, divisor 1, frequency 120MHz. It is used as the processor clock.
 * GCLK1 is fed from DPLL0, divisor 3660, frequency 32786.9Hz. It is used as the reference for DFLL48M. Only GCLK1 allows division by value >512 that are not powers of 2.
 * GCLK2 is fed from DPLL1, divisor 4, frequency 25MHz. It is used to clock the Ethernet Phy
 * GCLK3 is fed from DPLL0, divisor 2, frequency 60MHz. It is used to clock SERCOM (max 100MHz), ADC (max 100MHz), TCC, and TC devices (some TCs are max 100MHz)
 * GCLK4 is fed from DFLL48M, divisor 1, frequency 48MHz. it is used to clock USB.
 */
...
#define CONF_GCLK_GEN_1_DIV 763
#endif
// </h>
// </e>
